...
; Youth and Environment Risk and Promotive Scores (YERP)
;
; Project for CSS 600
;
; JoAnn Lee
...
turtles-own [
  ...
  family-pro                ;; an individual family's promotive probability
]
...
to setup
  ...
  ask school-patches [
    ...
    set pro-opp random-exponential-in-bounds (schools-promotive / 100) .01 .99
  ]
  ...
  ask neighborhood-patches [
    ...
    set risk-opp random-exponential-in-bounds (neighborhood-risk / 100) .01 .99
    set pro-opp random-exponential-in-bounds (neighborhood-promotive / 100) .01 .99
  ]
  ...
  create-turtles NUM-TURTLES [
    ...
    set family-pro random-exponential-in-bounds (promotive-level / 100) .01 .99
...
to turtles-go-to-school
  ...
  repeat SCHOOL-HOUR [
    ask turtles [
       ...
       if (member? patch-here neighborhood-patches) [turtle-in-neighborhood]
    ]
  ]
...
228
166
set family risk and promotive level between 1-99
11
0.0
1
...
333
296
set school and neighborhood risk and promotive level between 1-99
11
0.0
1
...
567
160
% more pro- or anti-social experiences
time
percent
0.0
350.0
...
"" ""
PENS
"antisocial" 1.0 0 -2674135 true "" "plot (count turtles with [antisocial > prosocial] / count turtles)"
"prosocial" 1.0 0 -13791810 true "" "plot (count turtles with [prosocial > antisocial] / count turtles)"
"equal" 1.0 0 -8630108 true "" "plot (count turtles with [ prosocial = antisocial] / count turtles)"
...
<experiments>
  <experiment name="Systematic Differences" repetitions="10" runMetricsEveryStep="false">
    ...
    <enumeratedValueSet variable="promotive-level">
      <value value="25"/>
      <value value="50"/>
      <value value="75"/>
    </enumeratedValueSet>
    ...
    <enumeratedValueSet variable="schools-promotive">
      <value value="25"/>
      <value value="50"/>
      <value value="75"/>
    </enumeratedValueSet>
    <enumeratedValueSet variable="neighborhood-risk">
      <value value="25"/>
      <value value="50"/>
      <value value="75"/>
    </enumeratedValueSet>
    <enumeratedValueSet variable="neighborhood-promotive">
      <value value="25"/>
      <value value="50"/>
      <value value="75"/>
    </enumeratedValueSet>
